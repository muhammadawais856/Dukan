...
class wheat extends StatefulWidget {
  final String name;
  final String image;
  const wheat({super.key,required this.name, required this.image});
...
class _wheatState extends State<wheat> {
  ...
  List<wheatlist> items = [
    ...
    wheatlist(name: "Brand", image: "Assets/images/brand2.png",),
  ...
  List<Product> product = [
    Product(title:" Grain Bag", image: "Assets/images/wheat3.png", price: 1200,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("${widget.name}${item.title}", maxLines:1,style: TextStyle(color:Color(0xFF000000), fontSize: 14,
